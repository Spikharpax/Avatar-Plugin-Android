...
## Installation
- Depuis le Play Store sur votre smartphone, installez l'application `Avatar Android Client` ([App Store](https://play.google.com/store/apps/details?id=com.automation.home.avatar.avatarandroidclient)).
